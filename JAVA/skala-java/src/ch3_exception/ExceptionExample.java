...
public class ExceptionExample {
    ...
    public static void main(String[] args) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("JAVA/skala-java/src/ch3_exception/data.txt"))) {
            // reader = new BufferedReader(
            // new FileReader("JAVA/skala-java/src/ch3_exception/data.txt"));
            String line;
